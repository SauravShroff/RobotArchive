...
get_filename_component(_filename "/home/turtlebot/ros_workspace/logitech/src/lab4_cam/srv/ImageSrv.srv" NAME_WE)
add_custom_target(_lab4_cam_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "lab4_cam" "/home/turtlebot/ros_workspace/logitech/src/lab4_cam/srv/ImageSrv.srv" "sensor_msgs/Image:std_msgs/Header"
)
...
_generate_srv_cpp(lab4_cam
  "/home/turtlebot/ros_workspace/logitech/src/lab4_cam/srv/ImageSrv.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab4_cam)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/lab4_cam\")")
  # install generated code
  install(
